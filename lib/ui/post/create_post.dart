...
import '../../models/posts/post.dart'; // Ensure Post model is imported
import '../../services/imgbb_service.dart'; // Import your ImgBB helper
...
class _CreatePostScreenState extends State<CreatePostScreen> {
  ...
  Future<void> _submitPost() async {
    ...
    try {
      ...
      // 2. Create the Post object with Denormalized user data
      final newPost = Post(
